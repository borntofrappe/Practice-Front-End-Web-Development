/*
include the data in the following format
{
  heading: string
  brief: string
  icon: svg syntax
...
const data = [
  ...
  {
    heading: "array.map()",
    brief: "Apply some logic on each array item.",
  ...
  },
  {
    ...
    brief: "Execute a function repeated for every array item.",
  ...
  {
    heading: "Object.keys()",
    brief: "Return all the keys of an object, in an array.",
  ...
  },
  {
    ...
    brief: "Destructure, access array items.",
